...
def main(model = "haarcascades/haarcascade_frontalface_default.xml", source = "image", archive = None, threshold = 1, source_path="T01T1CLGP3Q-U02F9EJP5GC-73c746e07316-192.jpg"):
	"""
	...
	face_recog.face_detection(source = source,path=source_path)
